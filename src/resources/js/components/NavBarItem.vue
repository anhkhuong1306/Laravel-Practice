...
import  styleStore  from "@/stores/index.js";
...
const componentClass = computed(() => {
  const base = [
    isDropdownActive.value
      ...
      : `${styleStore.navBarItemLabelStyle} dark:text-white dark:hover:text-slate-400 ${styleStore.state.navBarItemLabelHoverStyle}`,
